...
import pygame
from MapGUI.textures import *

#REFERENCES CODE FROM MELOONATIC
#BUT APPARENTLY HE ALREADY DELETED HIS VIDEOS
class Map_Engine:
    ...
    def load_map(file):
        ...
        for tile in tiles:
            ...
            if tile[1] in Tiles.Blocked_Types2:
                Tiles.Blocked2.append(tile[0])
