...
class Font:
    ...
    Default = pygame.font.SysFont("", 20)
    Small = pygame.font.SysFont("", 15)
    Medium = pygame.font.SysFont("", 40)
    Large = pygame.font.SysFont("", 60)
    Scanner = pygame.font.SysFont("", 30)
    Giga = pygame.font.SysFont("", 180)
...
class Menu:  
    ...
    class Button:
        ...
        def __init__(self, text, rect, bg, fg, bgr, font = Font.Medium, tag = ("menu", None)):
            self.Text = text
            self.Left = rect[0]
            self.Top = rect[1]
            self.Width = rect[2]
